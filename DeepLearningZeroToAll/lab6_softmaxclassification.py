# Lab 6 Softmax Classifier - 흑백으로 2개로 나뉘는 게 아닐 경우 필요 (argmax인 것을 찾아 사용 가능)
...
# softmax = exp(logits) / reduce_sum(exp(logits), dim) -> 숫자가 합이 1인 확률로 표현이 됨, 가장 큰 확률을 가진 arguement이 해당하는 값
