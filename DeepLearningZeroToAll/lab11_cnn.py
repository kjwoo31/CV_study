...
# class, layers를 사용하여 더 보기 좋게, 쉽게 할 수 있음
...
W1 = tf.Variable(tf.random_normal([3, 3, 1, 32], stddev=0.01)) # filter 크기 설정
#    Conv     -> (?, 28, 28, 32)
#    Pool     -> (?, 14, 14, 32)
...
Tensor("Reshape_1:0", shape=(?, 3136), dtype=float32) - feature 펼친 값
'''

# 3. 마지막, Fully Connected - layer 수를 늘리면 정확도 늘어남
