# Lab 12 RNN
# cell 생성 (rnn, lstm 등 구조 변형 가능) -> 학습, cell output/state 얻기
...
idx2char = ['h', 'i', 'e', 'l', 'o']
# Teach hello: hihell -> ihello - one hot encoding 하기
...
# (batch size, sequence length, hidden size) 모양만 알면 RNN Cell 구성 가능
...
# sequence loss 사용, loss가 낮을수록 정확
sequence_loss = tf.contrib.seq2seq.sequence_loss(
    logits=outputs, targets=Y, weights=weights) # logit: 예측, target: 정답, weight: 비중, 보통 다 1
